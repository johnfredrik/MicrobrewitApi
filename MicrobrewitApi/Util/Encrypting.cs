...
namespace Microbrewit.Api.Util
{
    public class Encrypting
    {
        ...
        public static byte[] Hash(byte[] value, byte[] salt)
        {
            ...
            return new SHA256Managed().ComputeHash(saltedValue, 0, 8);
        }

        public static byte[] GenerateSalt()
        {
            //Used to get securely generated bytes
        ...
        public static bool ValidatePassword(UserCredentials userCredentials, string password)
        {
            var passwordHash = Hash(password, userCredentials.Salt);
            var result = userCredentials.Password.SequenceEqual(passwordHash);
            return result;
